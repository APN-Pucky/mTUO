...
./build_tools/build-boost.sh --version=1.64.0 --stdlibs="gnu-4.9, llvm-3.5" --abis="armeabi-v7a, x86"  --ndk-dir=$ANDROID_NDK_ROOT --linkage="shared,static" --verbose $BOOST_SRC_DIR  2>&1 | tee -a $logFile 
